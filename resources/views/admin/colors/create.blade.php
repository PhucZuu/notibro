...
@section('content')
    <div class="container">
        <h2 class="text-info" style="font-size: 30px">Add New Color</h2>
        ...
        <div class="mt-4">
            <form action="{{ route('colors.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="color" class="form-control" id="code" name="code" placeholder="Enter color code (e.g., #ff5733)" value="{{ old('code') }}">
                </div>
